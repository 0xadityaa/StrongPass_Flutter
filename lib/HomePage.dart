                    ...
                    GestureDetector(
                      onTap: () {
                        if(_generatedPassword == "Your pswd will be here"){
                          Get.snackbar("Cannot Copy", "Clipboard is empty",snackPosition: SnackPosition.BOTTOM);
                        }else{
                        Clipboard.setData(ClipboardData(text: _generatedPassword)).then((value) { Get.snackbar("Copied!", "Text Copied to Clipboard",snackPosition: SnackPosition.BOTTOM);}
                        );}
                        setState(() {
                          _generatedPassword = "Your pswd will be here";
                        });
            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  onTap: () async{
                    await launch ('https://binarybeast-portfolio.netlify.app/');
                  },
                ),
              ],
            ),
